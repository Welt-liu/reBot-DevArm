...
| **Pinocchio 対応** | 🚧 進行中  | Pinocchio フレームワークへの対応を行い、ロボットアームの順運動学/逆運動学および重力補償機能を実現 | [GitHub リポジトリ](https://github.com/vectorBH6/reBotArm_control_py/tree/develop) 継続更新中 |
